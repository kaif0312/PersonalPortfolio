import { d as Je, h as nt, P as ne, c as ot, b as de, f as rt, i as Ee, e as S, n as co, g as ao, u as lo, a as Ct } from "./heading-DIulQwgD.mjs";
import { u as W, o as v, F as uo, G as Ae, H as Le, j as p, J as jt, K as kt, q as X, p as D, a1 as fo, W as po, b as ie, a as Te, S as Lt, n as oe } from "./index-uYyMBANY.mjs";
import { c as mo, b as Ft, u as ho, I as go, R as xo } from "./skeleton-qnvlkDy-.mjs";
import { a as Ve, P as vo, h as wo, u as yo, R as bo, F as Mo, D as Co, C as Ao } from "./dialog-VFomJYla.mjs";
function Po(e) {
  const [t, n] = W(void 0);
  return Je(() => {
    if (e) {
...
async function Pe(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: m = 0
  } = Q(t, e), h = zt(m), w = a[f ? l === "floating" ? "reference" : "floating" : l], x = He(await i.getClippingRect({
      ...
      if (E = [...E, {
        ...
        if (!R)
          switch (f) {
            case "bestFit": {
              var k;
              const O = (k = E.map((F) => [F.placement, F.overflows.filter((_) => _ > 0).reduce((_, z) => _ + z, 0)]).sort((F, _) => F[1] - _[1])[0]) == null ? void 0 : k[0];
              O && (R = O);
              break;
            }
...
function ze(e, t) {
  var n;
  t === void 0 && (t = []);
  const o = Wt(e), r = o === ((n = e.ownerDocument) == null ? void 0 : n.body), i = K(o);
  return r ? t.concat(i, i.visualViewport || [], Re(o) ? o : []) : t.concat(o, ze(o));
}
function Kt(e) {
  const t = Y(e);
...
function ue(e, t, n, o) {
  ...
  if (i) {
    ...
    for (; h && o && m !== f; ) {
      ...
      c *= g.x, u *= g.y, d *= g.x, l *= g.y, c += y, u += A, h = K(h).frameElement;
    }
  }
  return He({
    width: d,
...
function ar(e, t) {
  const n = K(e), o = re(e), r = n.visualViewport;
...
function ur(e, t) {
  ...
  if (n)
    return n;
  let o = ze(e).filter((a) => te(a) && ae(a) !== "body"), r = null;
...
function br(e) {
  ...
  const [h, g] = W(null), [w, x] = W(null), y = X((_) => {
    ...
    k.current && (_.platform = k.current), wr(M.current, E.current, _).then((z) => {
      const I = {
        ...z,
        isPositioned: !0
      };
  ...
  const R = Te(() => ({
    ...
    if (!O.floating)
      return _;
    const z = Dt(O.floating, d.x), I = Dt(O.floating, d.y);
    return a ? {
      ..._,
...
var ft = "PopperContent", [Pr, _r] = Jt(ft), rn = v(
  (e, t) => {
    ...
    const {
      ...
      altBoundary: L
    }, { refs: O, floatingStyles: F, placement: _, isPositioned: z, middlewareData: I } = br({
    ...
    const q = (J = I.arrow) == null ? void 0 : J.x, ve = (ye = I.arrow) == null ? void 0 : ye.y, we = ((V = I.arrow) == null ? void 0 : V.centerOffset) !== 0, [De, le] = W();
    return Je(() => {
 ...
 */
const Tr = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]], jr = Ee("chevron-right", Tr);
/**
 * @license lucide-react v0.553.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const kr = [["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]], Lr = Ee("circle", kr);
/**
 * @license lucide-react v0.553.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
var tt = ["Enter", " "], Hr = ["ArrowDown", "PageUp", "Home"], ln = ["ArrowUp", "PageDown", "End"], zr = [...Hr, ...ln], Gr = {
  ltr: [...tt, "ArrowRight"],
  rtl: [...tt, "ArrowLeft"]
}, Wr = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, Oe = "Menu", [_e, Kr, Vr] = mo(Oe), [fe, un] = ot(Oe, [
  Vr,
  Qt,
  Ft
]), Xe = Qt(), dn = Ft(), [Ur, pe] = fe(Oe), [Yr, Ne] = fe(Oe), fn = (e) => {
...
pt.displayName = Xr;
var mt = "MenuPortal", [qr, pn] = fe(mt, {
  forceMount: void 0
}), mn = (e) => {
  const { __scopeMenu: t, forceMount: n, children: o, container: r } = e, i = pe(mt, t);
  return /* @__PURE__ */ p.jsx(qr, { scope: t, forceMount: n, children: /* @__PURE__ */ p.jsx(Ve, { present: n || i.open, children: /* @__PURE__ */ p.jsx(vo, { asChild: !0, container: r, children: o }) }) });
};
mn.displayName = mt;
var U = "MenuContent", [Zr, ht] = fe(U), hn = v(
  (e, t) => {
    const n = pn(U, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, i = pe(U, e.__scopeMenu), s = Ne(U, e.__scopeMenu);
    return /* @__PURE__ */ p.jsx(_e.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ p.jsx(Ve, { present: o || i.open, children: /* @__PURE__ */ p.jsx(_e.Slot, { scope: e.__scopeMenu, children: s.modal ? /* @__PURE__ */ p.jsx(Jr, { ...r, ref: t }) : /* @__PURE__ */ p.jsx(Qr, { ...r, ref: t }) }) }) });
  }
), Jr = v(
  (e, t) => {
...
}), ei = ao("MenuContent.ScrollLock"), gt = v(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: o = !1,
      ...
      ...g
    } = e, w = pe(U, n), x = Ne(U, n), y = Xe(n), A = dn(n), P = Kr(n), [b, M] = W(null), E = D(null), j = de(t, E, w.onContentChange), T = D(0), k = D(""), N = D(0), L = D(null), R = D("right"), O = D(0), F = h ? bo : kt, _ = h ? { as: ei, allowPinchZoom: !0 } : void 0, z = (C) => {
      var J, ye;
      const H = k.current + C, $ = P().filter((V) => !V.disabled), q = document.activeElement, ve = (J = $.find((V) => V.ref.current === q)) == null ? void 0 : J.textValue, we = $.map((V) => V.textValue), De = fi(we, H, ve), le = (ye = $.find((V) => V.textValue === De)) == null ? void 0 : ye.ref.current;
      (function V(be) {
    ...
    const I = X((C) => {
      var $, q;
      return R.current === (($ = L.current) == null ? void 0 : $.side) && mi(C, (q = L.current) == null ? void 0 : q.area);
    }, []);
    return /* @__PURE__ */ p.jsx(
      Zr,
      {
        ...
        onItemLeave: X(
          (C) => {
            var H;
            I(C) || ((H = E.current) == null || H.focus(), M(null));
          },
          [I]
        ),
        onTriggerLeave: X(
        ...
        children: /* @__PURE__ */ p.jsx(F, { ..._, children: /* @__PURE__ */ p.jsx(
          Mo,
          {
            ...
            onMountAutoFocus: S(i, (C) => {
              var H;
              C.preventDefault(), (H = E.current) == null || H.focus({ preventScroll: !0 });
            }),
                    ...
                    children: /* @__PURE__ */ p.jsx(
                      Dr,
                      {
                        ...
                        onKeyDown: S(g.onKeyDown, (C) => {
                          ...
                          $ && (C.key === "Tab" && C.preventDefault(), !q && ve && z(C.key));
                          const we = E.current;
                          if (C.target !== we || !zr.includes(C.key)) return;
                          C.preventDefault();
                          const le = P().filter((J) => !J.disabled).map((J) => J.ref.current);
                          ln.includes(C.key) && le.reverse(), ui(le);
                        }),
                        onBlur: S(e.onBlur, (C) => {
                        ...
                        onPointerMove: S(
                          e.onPointerMove,
                          Se((C) => {
                            const H = C.target, $ = O.current !== C.clientX;
                            if (C.currentTarget.contains(H) && $) {
...
vn.displayName = oi;
var wn = "MenuRadioGroup", [ri, ii] = fe(
  wn,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ p.jsx(ri, { scope: e.__scopeMenu, value: n, onValueChange: i, children: /* @__PURE__ */ p.jsx(xt, { ...r, ref: t }) });
  }
);
yn.displayName = wn;
var bn = "MenuRadioItem", Mn = v(
  (e, t) => {
    const { value: n, ...o } = e, r = ii(bn, e.__scopeMenu), i = n === r.value;
...
Mn.displayName = bn;
var vt = "MenuItemIndicator", [Cn, si] = fe(
  vt,
  { checked: !1 }
), An = v(
  (e, t) => {
    const { __scopeMenu: n, forceMount: o, ...r } = e, i = si(vt, n);
    return /* @__PURE__ */ p.jsx(
      Ve,
      {
        present: o || Ke(i.checked) || i.checked === !0,
        children: /* @__PURE__ */ p.jsx(
          ne.span,
          {
            ...r,
...
_n.displayName = ai;
var li = "MenuSub", [fs, Sn] = fe(li), Ce = "MenuSubTrigger", En = v(
  (e, t) => {
    ...
    return ie(() => d, [d]), ie(() => {
      ...
      xn,
      {
        ...
        onKeyDown: S(e.onKeyDown, (l) => {
          ...
          e.disabled || f && l.key === " " || Gr[o.dir].includes(l.key) && (n.onOpenChange(!0), (m = n.content) == null || m.focus(), l.preventDefault());
        })
      }
    ) });
  }
...
var Rn = "MenuSubContent", On = v(
  (e, t) => {
    ...
    return /* @__PURE__ */ p.jsx(_e.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ p.jsx(Ve, { present: o || i.open, children: /* @__PURE__ */ p.jsx(_e.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ p.jsx(
      gt,
      {
        id: a.contentId,
        ...
        onKeyDown: S(e.onKeyDown, (d) => {
          var m;
          const l = d.currentTarget.contains(d.target), f = Wr[s.dir].includes(d.key);
...
var hi = fn, gi = pt, xi = mn, vi = hn, wi = xt, yi = gn, bi = qe, Mi = vn, Ci = yn, Ai = Mn, Pi = An, _i = Pn, Si = _n, Ei = En, Ri = On, Ze = "DropdownMenu", [Oi] = ot(
  Ze,
  [un]
), B = un(), [Ni, Dn] = Oi(Ze), In = (e) => {
  const {
  ...
  return /* @__PURE__ */ p.jsx(
    Ni,
    {
      ...
      modal: a,
      children: /* @__PURE__ */ p.jsx(hi, { ...c, open: d, onOpenChange: l, dir: o, modal: a, children: n })
    }
  );
};
In.displayName = Ze;
var Tn = "DropdownMenuTrigger", jn = v(
  (e, t) => {
    ...
    return /* @__PURE__ */ p.jsx(gi, { asChild: !0, ...s, children: /* @__PURE__ */ p.jsx(
      ne.button,
      {
        type: "button",
        id: i.triggerId,
...
jn.displayName = Tn;
var Di = "DropdownMenuPortal", kn = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, o = B(t);
  return /* @__PURE__ */ p.jsx(xi, { ...o, ...n });
};
kn.displayName = Di;
...
Hn.displayName = ji;
var ki = "DropdownMenuCheckboxItem", zn = v((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
  return /* @__PURE__ */ p.jsx(Mi, { ...r, ...o, ref: t });
});
zn.displayName = ki;
var Li = "DropdownMenuRadioGroup", Fi = v((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
  return /* @__PURE__ */ p.jsx(Ci, { ...r, ...o, ref: t });
});
Fi.displayName = Li;
var $i = "DropdownMenuRadioItem", Gn = v((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
  return /* @__PURE__ */ p.jsx(Ai, { ...r, ...o, ref: t });
});
Gn.displayName = $i;
var Bi = "DropdownMenuItemIndicator", Wn = v((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
  return /* @__PURE__ */ p.jsx(Pi, { ...r, ...o, ref: t });
});
Wn.displayName = Bi;
var Hi = "DropdownMenuSeparator", Kn = v((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
  return /* @__PURE__ */ p.jsx(_i, { ...r, ...o, ref: t });
});
Kn.displayName = Hi;
var zi = "DropdownMenuArrow", Gi = v(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
    return /* @__PURE__ */ p.jsx(Si, { ...r, ...o, ref: t });
  }
);
Gi.displayName = zi;
var Wi = "DropdownMenuSubTrigger", Vn = v((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
  return /* @__PURE__ */ p.jsx(Ei, { ...r, ...o, ref: t });
});
Vn.displayName = Wi;
var Ki = "DropdownMenuSubContent", Un = v((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = B(n);
  return /* @__PURE__ */ p.jsx(
    Ri,
    {
...
Un.displayName = Ki;
var Vi = In, Ui = jn, Yi = kn, Yn = Fn, Xi = $n, Xn = Bn, qn = Hn, Zn = zn, Jn = Gn, Qn = Wn, eo = Kn, to = Vn, no = Un;
const ps = Vi, ms = Ui, hs = Xi, qi = v(({ className: e, inset: t, children: n, ...o }, r) => /* @__PURE__ */ p.jsxs(
  to,
  {
    ref: r,
    className: oe(
    ...
    children: [
      n,
      /* @__PURE__ */ p.jsx(jr, { className: "ml-auto" })
    ]
  }
));
...
const Ji = v(({ className: e, sideOffset: t = 4, ...n }, o) => /* @__PURE__ */ p.jsx(Yi, { children: /* @__PURE__ */ p.jsx("div", { className: Lt, children: /* @__PURE__ */ p.jsx(
  Yn,
  {
    ref: o,
    className: oe(
...
const ts = v(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ p.jsxs(
  Jn,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ p.jsx("span", { className: "absolute left-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ p.jsx(Qn, { children: /* @__PURE__ */ p.jsx(Lr, { className: "size-2 fill-current" }) }) }),
      t
    ]
  }
));
...
//# sourceMappingURL=separator-YrJkDGVP.mjs.map
