import { d as O, j as s, g as A, R as E, n as G, e as b, a as g, c as V } from "./index-uYyMBANY.mjs";
import { B as H } from "./heading-DIulQwgD.mjs";
import { E as K } from "./empty-indicator-CT9qQsMO.mjs";
import { A as q, C, a as v, b as S, g as $, c as w, U as J, j as Q, T as X, P as Y, f as Z, W as ss, m as es } from "./post-analytics-header-BBxuaptK.mjs";
import { p as rs, e as as, S as L } from "./source-icon-DBU0eZwS.mjs";
import { S as ts, a as cs, b as ns, c as os, d as is, e as ls } from "./sheet-T5GWxxrn.mjs";
import { T as ds, a as ms, b as R, c as N, d as hs, e as y } from "./table-Cu0BZfBU.mjs";
import { u as xs, d as us, e as js, K as k, f as W, a as M, b as T, c as P } from "./stats-udwJVZP8.mjs";
import { S as F, U as ps } from "./separator-YrJkDGVP.mjs";
import { S as U, a as bs } from "./skeleton-qnvlkDy-.mjs";
import { u as fs } from "./post-analytics-context-B5zQoflZ.mjs";
function _(a) {
...
const gs = ({ className: a }) => {
  ...
  if (e === "growth")
    return /* @__PURE__ */ s.jsxs(ds, { children: [
      /* @__PURE__ */ s.jsx(ms, { children: /* @__PURE__ */ s.jsxs(R, { children: [
  ...
  const { data: a } = fs(), { postId: c } = V(), { stats: l, totals: e, isLoading: n, currencySymbol: t } = ys(c || ""), { appSettings: r } = A(), d = O(), m = a == null ? void 0 : a.url, i = a == null ? void 0 : a.icon;
    ...
    /* @__PURE__ */ s.jsx(Z, { children: n ? /* @__PURE__ */ s.jsxs("div", { className: j, children: [
      ...
      /* @__PURE__ */ s.jsxs(C, { className: h, children: [
        ...
        /* @__PURE__ */ s.jsxs(w, { children: [
          /* @__PURE__ */ s.jsx(F, {}),
          /* @__PURE__ */ s.jsx(bs, { className: "pt-6" })
        ] })
      ] })
      ...
      !(r != null && r.paidMembersEnabled) && /* @__PURE__ */ s.jsx(F, {}),
      /* @__PURE__ */ s.jsx(
        Ns,
        {
          className: h,
...
//# sourceMappingURL=growth-xMitvyvt.mjs.map
