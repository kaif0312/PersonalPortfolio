import { o as i, j as t, S as x, n as o, V as f } from "./index-uYyMBANY.mjs";
import { d as h, j as g, e as u, f as d, i as y, X as N, T as n, g as l, O as r } from "./dialog-VFomJYla.mjs";
...
const j = f(
  ...
  /* @__PURE__ */ t.jsxs(
    d,
    {
      ...
      ...m,
      children: [
        /* @__PURE__ */ t.jsxs(y, { className: "fixed right-4 top-4 z-50 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [
...
//# sourceMappingURL=sheet-T5GWxxrn.mjs.map
