import { b as j, d as fe, f as V, P as L, e as F, n as gt, u as yt, c as Et, a as oe, g as bt, o as Ct, i as Me } from "./heading-DIulQwgD.mjs";
import { G as he, J as Re, u as I, p as S, b as w, q as M, a2 as St, o as N, E as Ie, D as wt, j as m, a3 as Nt, W as Dt, x as R, K as Le, a as xt, S as Pt, n as $ } from "./index-uYyMBANY.mjs";
var O = function() {
...
var It = "DismissableLayer", ve = "dismissableLayer.update", Lt = "dismissableLayer.pointerDownOutside", _t = "dismissableLayer.focusOutside", Ee, Fe = wt({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: i,
      ...f
    } = e, u = Ie(Fe), [l, d] = I(null), h = (l == null ? void 0 : l.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, p] = I({}), x = j(t, (y) => d(y)), c = Array.from(u.layers), [v] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), g = c.indexOf(v), D = l ? c.indexOf(l) : -1, E = u.layersWithOutsidePointerEventsDisabled.size > 0, b = D >= g, C = jt((y) => {
...
var ie = "focusScope.autoFocusOnMount", se = "focusScope.autoFocusOnUnmount", Se = { bubbles: !1, cancelable: !0 }, Ht = "FocusScope", Be = N((e, t) => {
  const {
    ...
    ...s
  } = e, [i, f] = I(null), u = V(o), l = V(a), d = S(null), h = j(t, (c) => f(c)), p = S({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  w(() => {
    ...
    if (i) {
      ...
      if (!i.contains(c)) {
        const g = new CustomEvent(ie, Se);
        i.addEventListener(ie, u), i.dispatchEvent(g), g.defaultPrevented || ($t(Xt(Ue(i)), { select: !0 }), document.activeElement === c && _(i));
      }
      return () => {
        i.removeEventListener(ie, u), setTimeout(() => {
          const g = new CustomEvent(se, Se);
          i.addEventListener(se, l), i.dispatchEvent(g), g.defaultPrevented || _(c ?? document.body, { select: !0 }), i.removeEventListener(se, l), Ne.remove(p);
        }, 0);
      };
    }
  }, [i, u, l, p]);
  const x = M(
    (c) => {
      ...
      if (v && g) {
        ...
        E && b ? !c.shiftKey && g === b ? (c.preventDefault(), n && _(E, { select: !0 })) : c.shiftKey && g === E && (c.preventDefault(), n && _(b, { select: !0 })) : g === D && c.preventDefault();
      }
    },
    [n, r, p.paused]
  );
...
var Ke = sn(), le = function() {
  ...
  }), o = r[0], a = r[1], s = e.forwardProps, i = e.children, f = e.className, u = e.removeScrollBar, l = e.enabled, d = e.shards, h = e.sideCar, p = e.noIsolation, x = e.inert, c = e.allowPinchZoom, v = e.as, g = v === void 0 ? "div" : v, D = e.gapMode, E = _e(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), b = h, C = rn([n, t]), A = O(O({}, E), o);
  return R(
    Le,
    null,
    l && R(b, { sideCar: Ke, removeScrollBar: u, shards: d, noIsolation: p, inert: x, setCallbacks: a, allowPinchZoom: !!c, lockRef: n, gapMode: D }),
    s ? Re(he.only(i), O(O({}, A), { ref: C })) : R(g, O({}, A, { className: f, ref: C }), i)
  );
});
te.defaultProps = {
  enabled: !0,
...
var vn = function() {
  ...
  if (e === void 0 && (e = "margin"), typeof window > "u")
    return hn;
  var t = pn(e), n = document.documentElement.clientWidth, r = window.innerWidth;
  return {
    left: t[0],
    top: t[1],
    right: t[2],
...
var B = me ? { passive: !1 } : !1, Sn = function(e) {
  ...
  do {
    var p = Xe(e, i), x = p[0], c = p[1], v = p[2], g = c - v - a * x;
    (x || g) && Ge(e, i) && (d += g, h += x), i instanceof ShadowRoot ? i = i.host : i = i.parentNode;
  } while (
    // portaled content
...
function Rn(e) {
  ...
  var i = M(function(c, v) {
    ...
    var g = q(c), D = n.current, E = "deltaX" in c ? c.deltaX : D[0] - g[0], b = "deltaY" in c ? c.deltaY : D[1] - g[1], C, A = c.target, y = Math.abs(E) > Math.abs(b) ? "h" : "v";
    ...
    if (!(!U.length || U[U.length - 1] !== a)) {
      var g = "deltaY" in v ? Ae(v) : q(v), D = t.current.filter(function(C) {
        return C.name === v.type && (C.target === v.target || v.target === C.shadowParent) && An(C.delta, g);
      })[0];
      if (D && D.should) {
    ...
    var E = { name: c, delta: v, target: g, should: D, shadowParent: In(g) };
...
Je.displayName = Qe;
var pe = "DialogPortal", [Fn, et] = qe(pe, {
  forceMount: void 0
}), tt = (e) => {
...
], cr = Me("x", Xn), ur = Kn, lr = Vn, Yn = zn, pt = N(({ className: e, ...t }, n) => /* @__PURE__ */ m.jsx(
  ft,
  {
    ref: n,
    className: $(
...
//# sourceMappingURL=dialog-VFomJYla.mjs.map
