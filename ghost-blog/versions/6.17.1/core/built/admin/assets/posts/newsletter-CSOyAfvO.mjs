import { D as he, a as j, j as e, E as st, o as R, F as at, G as B, H as W, J as ye, K as rt, u as $, b as D, p as ae, n as E, R as U, c as nt, d as Ce, f as A, L as be, M as it, N as ot, Q as lt, g as ct, e as O } from "./index-uYyMBANY.mjs";
import { h as dt, f as ut, d as re, B as V, H as Le } from "./heading-DIulQwgD.mjs";
import { s as mt, c as pt } from "./hooks-BiBMDYOA.mjs";
import { C as ne, a as ie, b as oe, g as le, c as T, j as Pe, T as gt, h as xt, P as ft, f as ht, n as bt } from "./post-analytics-header-BBxuaptK.mjs";
import { S as ce, f as vt } from "./separator-YrJkDGVP.mjs";
import { ab as jt, a5 as kt, a6 as Nt, a7 as wt, ac as ve, ad as yt, ae as Ct, D as Lt, a as Pt, b as St, c as _t, d as At, e as Rt, f as Ft, g as $t, af as Et } from "./tabs-B-RaoD3I.mjs";
import { a as Se } from "./skeleton-qnvlkDy-.mjs";
import { g as Tt, h as It, K as Q, f as Z, a as J, b as X, c as ee } from "./stats-udwJVZP8.mjs";
import { B as zt } from "./loading-indicator-BPPeKpVb.mjs";
import { a as Mt, u as Bt, p as Dt, g as te, N as se } from "./links-CBiYZsyk.mjs";
import { u as Vt } from "./post-analytics-context-B5zQoflZ.mjs";
import { g as je } from "./posts-DW6ne0od.mjs";
function Ut(t, s = []) {
  let a = [];
  function r(n, o) {
    const l = he(o);
...
const is = "FeedbackResponseType", os = pt({
  ...
  return /* @__PURE__ */ e.jsxs(ne, { children: [
    ...
    t.totalFeedback > 0 ? /* @__PURE__ */ e.jsxs(T, { className: "pb-3", children: [
      /* @__PURE__ */ e.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ e.jsx(Nt, { className: "pb-3", defaultValue: "positive", value: r, variant: "button", onValueChange: (v) => i(v), children: /* @__PURE__ */ e.jsxs(wt, { className: "gap-1", children: [
  ...
  const { mutateAsync: t, isLoading: s } = Mt();
  return {
    editLinks: t,
  ...
  }, [n]), { data: c, isLoading: x } = Tt({
    searchParams: m ? { newsletter_id: m } : {},
    enabled: !!m
  }), g = j(() => c != null && c.stats ? c.stats.map((b) => b.post_id) : [], [c]), { data: k, isLoading: p } = It({
  ...
  const t = Ce(), [s, a] = $(null), [r, i] = $(""), n = ae(null), o = ae(null), l = 10, { chartSize: u } = ms(), { appSettings: m } = ct(), { emailTrackClicks: c, emailTrackOpens: x } = (m == null ? void 0 : m.analytics) || {}, { post: g, isPostLoading: k, postId: p } = Vt(), f = g, v = xt(f);
  D(() => {
  ...
  return (!c || !x) && (z = "grid-cols-2", M = "aspect-[16/10] w-full max-w-[320px] sm:aspect-[2/1] md:aspect-square md:max-w-none lg:aspect-[15/10]"), !c && !x && (z = "grid-cols-1", M = "aspect-square w-full sm:aspect-[16/10] md:max-w-[320px] md:max-h-[320px] lg:aspect-[12/10]"), /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    ...
    /* @__PURE__ */ e.jsx(ht, { children: /* @__PURE__ */ e.jsxs("div", { className: `grid grid-cols-1 gap-6 ${y && c && "lg:grid-cols-2"}`, children: [
      /* @__PURE__ */ e.jsxs(ne, { className: y && c ? "lg:col-span-2" : "", children: [
        ...
        Y ? /* @__PURE__ */ e.jsx(T, { className: "h-[25vw] p-6", children: /* @__PURE__ */ e.jsx(zt, {}) }) : /* @__PURE__ */ e.jsxs(T, { className: "p-0", children: [
      ...
      c && /* @__PURE__ */ e.jsxs(ne, { className: "group/datalist overflow-hidden", children: [
        ...
        Y ? /* @__PURE__ */ e.jsxs(T, { className: "p-6 pt-0", children: [
          ...
          /* @__PURE__ */ e.jsx(ce, {}),
          P.length > 0 ? /* @__PURE__ */ e.jsx(Lt, { className: "", children: /* @__PURE__ */ e.jsx(Pt, { children: q == null ? void 0 : q.map((d) => {
            ...
            return /* @__PURE__ */ e.jsxs(St, { children: [
              s !== F && /* @__PURE__ */ e.jsx(_t, { style: {
                width: `${N ? Math.round(N * 100) : 0}%`
              } }),
              /* @__PURE__ */ e.jsx(At, { className: "w-full", children: s === F ? /* @__PURE__ */ e.jsxs("div", { ref: o, className: "flex w-full items-center gap-2", children: [
                /* @__PURE__ */ e.jsx(
                  Ve,
                  {
                    ref: n,
              ...
              /* @__PURE__ */ e.jsxs(Rt, { children: [
                /* @__PURE__ */ e.jsx(Ft, { children: O(d.count || 0) }),
                /* @__PURE__ */ e.jsx($t, { children: A(N) })
              ] })
            ] }, F);
...
//# sourceMappingURL=newsletter-CSOyAfvO.mjs.map
