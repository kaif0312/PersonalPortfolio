import { f as u, j as t, q as B, r as G, D as K, B as v, c as p, G as T } from "./index-Banm1wtA.mjs";
import { bB as L, P as W, Q as q, Z as H, R as f, bC as C, bD as O, bE as Q, T as y, a0 as U, o as Z, bF as J, bG as X, B as Y, ag as ee } from "./stats-CjepXEWS.mjs";
var h = "Tabs", [te] = q(h, [
  C
]), w = C(), [ae, N] = te(h), k = u(
  (e, a) => {
...
var V = "TabsTrigger", A = u(
  (e, a) => {
    const { __scopeTabs: n, value: s, disabled: r = !1, ...i } = e, o = N(V, n), d = w(n), g = F(o.baseId, s), m = M(o.baseId, s), c = s === o.value;
    return /* @__PURE__ */ t.jsx(
      Q,
      {
        asChild: !0,
...
var P = "TabsContent", E = u(
  (e, a) => {
    const { __scopeTabs: n, value: s, forceMount: r, children: i, ...o } = e, d = N(P, n), g = F(d.baseId, s), m = M(d.baseId, s), c = s === d.value, l = B(c);
    return G(() => {
...
var R = k, D = _, j = A, S = E;
const x = K("segmented"), se = u(({ variant: e = "segmented", ...a }, n) => /* @__PURE__ */ t.jsx(x.Provider, { value: e, children: /* @__PURE__ */ t.jsx(R, { ref: n, ...a }) }));
...
//# sourceMappingURL=tabs-Q20S1oup.mjs.map
