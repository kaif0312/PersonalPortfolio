import { u as J, b as Y, a as re, O as ne, d as q, n as h, g as S, r as le, j as e, h as _, $ as ge, e as ie, X as fe, o as Z, p as I, P as be, R as ee } from "./index-Banm1wtA.mjs";
import { aA as je, j as ae, af as ve, ag as ke, ah as Ne, ai as U, k as we, bf as ye, bi as _e, bj as Ce, bk as Te, bg as Se, bs as Re, bm as Le, E as oe, m as se, bq as ce, ba as De, bb as Me, bt as Pe, bc as Oe, bd as Be, bu as Ee, bv as Ae, be as ze, bw as $e, bx as Ve, by as He, y as Ke, z as We, N as Fe, D as Ge, A as Ie, a as de, e as ue, b as Ye, c as qe, d as Qe, q as Ue, B as Xe } from "./stats-CjepXEWS.mjs";
import { T as Je, a as Ze, K as X, c as B, d as es } from "./tabs-Q20S1oup.mjs";
import { B as ss, d as ts, T as as, e as rs, a as G, f as V, S as F, b as M } from "./sort-button-i6PS-TUn.mjs";
const ns = ({ active: a, payload: s }) => {
  ...
  const A = o === "avg-open-rate" && C > f[0] && C < f[1] || o === "avg-click-rate" && l > f[0] && l < f[1], O = o === "avg-open-rate" ? C : l;
  return /* @__PURE__ */ e.jsxs(Je, { defaultValue: i, variant: "kpis", children: [
    /* @__PURE__ */ e.jsxs(Ze, { className: `-mx-6 hidden grid-cols-3 md:!visible md:!grid ${E}`, children: [
      /* @__PURE__ */ e.jsx(X, { className: `${!g && !p && "cursor-auto after:hidden"}`, value: "total-subscribers", onClick: () => {
        v("total-subscribers");
      ...
      g && /* @__PURE__ */ e.jsx(X, { value: "avg-open-rate", onClick: () => {
        v("avg-open-rate");
      }, children: /* @__PURE__ */ e.jsx(
        B,
        {
        ...
        /* @__PURE__ */ e.jsx(ye, { className: "aspect-auto h-[200px] w-full md:h-[220px] xl:h-[320px]", config: T, children: /* @__PURE__ */ e.jsxs(
          ss,
          {
            ...
            children: [
              ...
              A && /* @__PURE__ */ e.jsx(Re, { label: { value: `${_(O)}`, position: "left", offset: 8, fill: "hsl(var(--muted-foreground))" }, opacity: 0.5, stroke: "hsl(var(--muted-foreground))", strokeDasharray: "4 4", y: O }),
              /* @__PURE__ */ e.jsx(
                Le,
                {
  ...
  const t = re(), { settings: i } = Y(), o = String(((C = i.find((l) => l.key === "timezone")) == null ? void 0 : C.value) || "Etc/UTC"), { data: x, isLoading: u, isClicksLoading: j } = me(
    ...
    /* @__PURE__ */ e.jsx(M, { className: "font-medium", children: /* @__PURE__ */ e.jsx("div", { className: "group/link inline-flex items-center gap-2", children: l.post_id ? /* @__PURE__ */ e.jsx(Xe, { className: "h-auto whitespace-normal p-0 text-left hover:!underline", title: "View post analytics", variant: "link", onClick: () => {
...
const fs = () => {
  const { range: a, selectedNewsletterId: s } = Y(), [r] = ne(), { appSettings: n } = q(), t = r.get("tab") || "total-subscribers", { data: i, isLoading: o } = cs({
    ...
    if (c != null && c.stats && c.stats.length > 0) {
      const f = c.stats, H = f.reduce((A, O) => A + (O.open_rate || 0), 0), E = f.reduce((A, O) => A + (O.click_rate || 0), 0);
...
//# sourceMappingURL=index-_vL3Zubi.mjs.map
